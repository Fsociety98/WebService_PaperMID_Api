...
namespace WebService_PaperMID_Api.DAL
{
    public class MensajeDAL
    {
        ...
        public int Agregar(object Obj)
        {
            ...
            Cmd.Parameters.Add("@RazonSocio", SqlDbType.VarChar).Value = oUsuarioModel.RazonSocioUsu;
        ...
        {
            UsuarioModel oUsuarioModel = (UsuarioModel)Obj;
            SqlCommand Cmd = new SqlCommand("EXEC SP_Modificar_Usuario @IdUsuario, @Usuario, @NombreUsu, @ApellidoPaternoUsu, @ApellidoMaternoUsu, @RFCUsu, @RazonSocio, @TelefonoUsu, @CorreoUsu, @IdTipoUsuario1,@IdDireccion2");
            ...
            Cmd.Parameters.Add("@CorreoUsu", SqlDbType.VarChar).Value = oUsuarioModel.CorreoUsu;
            Cmd.Parameters.Add("@IdTipoUsuario1", SqlDbType.Int).Value = oUsuarioModel.IdTipoUsuario1;
            Cmd.Parameters.Add("@IdDireccion2", SqlDbType.Int).Value = oUsuarioModel.IdDireccion2;
            Cmd.CommandType = CommandType.Text;
            return oConexionDAL.EjecutarSQL(Cmd);
        }
        ...
        public List<UsuarioModel> TablaUsuarios()
        {
            try
            {
                string Query = ("SELECT * FROM Vst_Lista_Usuarios");
